...
>*Answer 1: Since the fynbos has meditterranean climate, seasonal fluctuations means that the amount of greenness will also vary over time*
...
>*Answer 2: The common estimates in the full model have changed compared to the first model. alpha estimates and lambda estimates decreased while gamma estimates increased in the full model*
...
>*Answer 5: AIC_full due to it having lowest AIC value*
...
>*Answer 6: AIC needs log-likelihood to be maximised, and models fitted by maximum likelihood and those not fitted can't be compared*
